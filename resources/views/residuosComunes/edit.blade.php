...
<head>
    ...
    <title>Editar Residuo - ProsarApp</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Editar Residuo</h4>
                        @if($errors->any())
                        ...
                        @endif
                        <form role="form" action="{{ route('residuoscomunes.update', $residuo->RespelSlug) }}" method="POST" enctype="multipart/form-data" data-bs-toggle="validator" class="form">
                            @csrf
                            @if(isset($residuo))
                                @method('PUT')
                            @endif
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('respelname') is-invalid @enderror" 
                                       id="respelname" name="respelname" value="{{ old('respelname', $residuo->RespelName ?? '') }}" required>
                                @error('respelname')
                            ...
                            <div class="mb-3">
                                ...
                                id="respeldescripcion" name="respeldescripcion" value="{{ old('respeldescripcion', $residuo->RespelDescrip ?? '') }}" required>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">
                                    {{ isset($residuo) ? 'Actualizar' : 'Guardar' }}
                                </button>
                            </div>
                        </form>
                    </div>
