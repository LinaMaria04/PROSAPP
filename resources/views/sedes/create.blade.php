...
<head>
    ...
    <title>Crear Sedes - ProsarApp</title>
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">{{ isset($sede) ? 'Editar Sede' : 'Crear Sede' }}</h4>
                        ...
                        <form action="{{ isset($sede) ? route('sedes.update', $sede->id) : route('sedes.store') }}" id="sedeform" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('correo') is-invalid @enderror" 
                                       id="correo" name="correo" value="" required>
                                @error('correo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <script>
        ...
        function iniciarMapa() {
            var latitud = parseFloat($('.search_latitude').val()) || 4.6831679; //Obtiene la latitud de entrada y se convierte en números flotantes, y se deja un valor predeterminado
            var longitud = parseFloat($('.search_longitude').val()) || -74.2717208; //Obtiene la longitud de entrada y se convierten en números flotantes, y se deja un valor predeterminado
