...
<head>
    ...
    <title>Editar Servicio - ProsarApp</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Editar Servicio</h4>
                        @if($errors->any())
                        ...
                        @endif
                        <form role="form" action="{{ route('solservicios.update', $servicio->ID_SolSer) }}" method="POST" enctype="multipart/form-data" data-bs-toggle="validator" class="form">
                            @csrf
                            @if(isset($servicio))
                                @method('PUT')
                            @endif
                            ...
                            <div class="mb-3">
                                ...
                                id="numserv" name="numserv" value="{{ old('ID_SolSer', $servicio->ID_SolSer ?? '') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                id="respelkg" name="respelkg" value="{{ old('respelkg', $servicio->SolResKgEnviado ?? '') }}" required>
                                @error('respelkg')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
